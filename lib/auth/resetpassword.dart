...
class _ResetPasswordState extends State<ResetPassword> {
  ...
  void resetpassword(context) async {
    ...
    try {
      var response = await dio.post(api_url + "/auth/password_reset/confirm/",
            ...
            Expanded(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      inputFile(label: "Token", controller: tokencontroller),
                      inputFile(label: "New-Password", controller: passwordcontroller),
                    ],
                  ),
                ),
                Padding(
                  ...
                  child: Container(
                    ...
                    child: MaterialButton(
                      ...
                      height: 60,
                      onPressed: () {
                        if (passwordcontroller.text == "" ||tokencontroller.text == ""  ) {
